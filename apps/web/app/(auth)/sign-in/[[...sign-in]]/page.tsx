    ...
    <div className="w-full">
        ...
        <SignIn
          appearance={{
            ...
            elements: {
              ...
              headerTitle: "font-[family-name:var(--font-serif)] text-3xl font-bold text-[var(--color-foreground)] tracking-tight",
              headerSubtitle: "text-[var(--color-muted)] text-base font-medium",
              socialButtonsBlockButton: "bg-white border border-[var(--color-border)] rounded-xl py-3 hover:bg-[var(--color-bg)] transition-colors shadow-sm text-base font-semibold text-[var(--color-foreground)]",
              ...
              formFieldLabel: "text-sm font-semibold text-[var(--color-foreground)] mb-1.5",
              formFieldInput: "bg-[var(--color-panel)] border-[var(--color-border)] rounded-xl py-2.5 px-4 text-base focus:ring-2 focus:ring-[var(--color-primary)] font-medium text-[var(--color-foreground)] transition-shadow",
              formButtonPrimary: "bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary)]/90 hover:shadow-md transition-all shadow-sm rounded-xl py-3 text-base font-semibold",
              footerActionText: "text-[var(--color-muted)] font-medium text-sm",
              footerActionLink: "text-[var(--color-primary)] font-semibold hover:text-[var(--color-accent)] transition-colors",
              identityPreviewText: "text-[var(--color-foreground)] font-semibold",
              identityPreviewEditButtonIcon: "text-[var(--color-muted)] hover:text-[var(--color-primary)]",
            },
          }}
          routing="path"
          path="/sign-in"
      ...
      <ClerkFailed>
        <div className="p-8 bg-white border border-[var(--color-border)] rounded-3xl text-center shadow-sm w-full">
          ...
          <h3 className="text-xl font-bold text-[var(--color-foreground)] mb-2">Authentication Unavailable</h3>
