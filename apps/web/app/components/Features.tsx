    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 sm:mb-24 px-4 flex flex-col items-center">
          <span className="text-[#f2a60c] font-semibold tracking-wider uppercase text-sm mb-4">
            Capabilities
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-[family-name:var(--font-serif)] tracking-tight mb-6 text-balance">
            Delegate everything to StarFire.
          </h2>
          <p className="text-white/70 text-base md:text-lg lg:text-xl max-w-3xl mx-auto font-medium text-balance">
            Connect your workflows, clarify your intent, and let StarFire
            execute flawlessly on your behalf.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {/* Card 1 */}
          <div className="card group relative overflow-hidden bg-white/5 hover:bg-white/10 p-8 sm:p-10 transition-all duration-300 rounded-3xl">
            <div className="w-14 h-14 rounded-2xl bg-[#f2a60c]/10 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
              <Briefcase className="w-7 h-7 text-[#f2a60c]" />
            </div>
            ...
            <p className="text-white/60 leading-relaxed text-base sm:text-lg mb-8">
              Tell StarFire your ideal role. It will continuously scour job
            ...
            <Button
              href="/dashboard"
              variant="ghost"
              className="px-0 hover:bg-transparent text-white/80 hover:text-[#f2a60c] !justify-start transition-colors"
            >
          ...
          {/* Card 2 */}
          <div className="card group relative overflow-hidden bg-white/5 hover:bg-white/10 p-8 sm:p-10 transition-all duration-300 rounded-3xl">
            <div className="w-14 h-14 rounded-2xl bg-[#3e6d4c]/20 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
            ...
            <p className="text-white/60 leading-relaxed text-base sm:text-lg mb-8">
              ...
              sequence once, and StarFire executes it flawlessly millions of
              times without fatigue.
            </p>
            <Button
              href="/dashboard"
              variant="ghost"
              className="px-0 hover:bg-transparent text-white/80 hover:text-[#4ade80] !justify-start transition-colors"
            >
          ...
          {/* Card 3 - Large Span */}
          <div className="card group relative overflow-hidden bg-gradient-to-br from-neutral-900 to-black p-8 sm:p-10 transition-all duration-300 md:col-span-2 flex flex-col md:flex-row items-center md:items-start gap-8 justify-between rounded-3xl">
            <div className="flex-1">
              ...
              <p className="text-white/60 leading-relaxed text-base sm:text-lg mb-8 max-w-2xl">
                Not just a chatbot. StarFire spins up headless browsers,
            ...
            <div className="hidden md:flex w-64 h-64 relative rounded-full items-center justify-center">
              <div className="w-48 h-48 rounded-full animate-[spin_10s_linear_infinite] border-dashed opacity-10"></div>
